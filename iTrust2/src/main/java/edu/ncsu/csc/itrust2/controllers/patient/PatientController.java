...
public class PatientController {
    ...
    /**
     * Retrieves the page for the Patient to add blood sugar level.
     *
     * @param model
     *            Data for the front end
     * @return The page the patient to add blood sugar level.
     */
    @GetMapping ( "/patient/bloodSugarLevel/addBloodSugarLevel" )
    @PreAuthorize ( "hasRole('ROLE_PATIENT')" )
    public String addBloodSugarLevelForm ( final Model model ) {
        return "/patient/bloodSugarLevel/addBloodSugarLevel";
    }

    /**
     * Retrieves the page for the Patient to view blood sugar level.
     *
     * @param model
     *            Data for the front end
     * @return The page the patient to view blood sugar level.
     */
    @GetMapping ( "/patient/bloodSugarLevel/viewBloodSugarLevel" )
    @PreAuthorize ( "hasRole('ROLE_PATIENT')" )
    public String viewBloodSugarLevelForm ( final Model model ) {
        return "/patient/bloodSugarLevel/viewBloodSugarLevel";
    }
}
