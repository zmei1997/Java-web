...
public enum TransactionType {
    ...
    /**
     * BSL Limits is created
     */
    BLOODSUGARLEVEL_LIMITS_CREATE(2700, "BSL limits created", true),
    /**
     * BSL Limits is viewed
     */
    BLOODSUGARLEVEL_LIMITS_VIEW(2701, "BSL limits viewed", true),
    /**
     * BSL Limits is updated
     */
    BLOODSUGARLEVEL_LIMITS_EDIT(2702, "BSL limits updated", true), 
    /**
     * BSL daily is created
     */
    CREATE_BSL_DAILY_ENTRY(2601, "BSL Daily Entry created", true),
    /**
     * BSL Limits is viewed
     */
    VIEW_BSL_DAILY_ENTRY(2602, "BSL Daily Entry viewed", true),
    /**
     * BSL Limits is updated
     */
    UPDATE_BSL_DAILY_ENTRY(2603, "BSL Daily Entry updated", true)
    ;
