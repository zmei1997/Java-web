...
public class HCPController {
    ...
    /**
     * Returns the page allowing HCPs to set blood sugar limit to each patient
     *
     * @return The page to display
     */
    @GetMapping ( "/hcp/setBloodSugarLimit" )
    @PreAuthorize ( "hasAnyRole('ROLE_HCP', 'ROLE_OD', 'ROLE_OPH')" )
    public String setBloodSugarLimit () {
        return "/hcp/setBloodSugarLimit";
    }
     ...
     * @return The page to display
     */
    @GetMapping ( "/hcp/viewPatientBloodSugarLevel" )
    @PreAuthorize ( "hasAnyRole('ROLE_HCP', 'ROLE_OD', 'ROLE_OPH')" )
    public String viewPatientBloodSugarLevel () {
        return "/hcp/viewPatientBloodSugarLevel";
    }
}
