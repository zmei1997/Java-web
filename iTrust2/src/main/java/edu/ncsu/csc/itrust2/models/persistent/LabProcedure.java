...
public class LabProcedure extends DomainObject<LabProcedure> {
    ...
    public LabProcedure ( final LabProcedureForm lpf ) throws ParseException, NumberFormatException {
        ...
        // new for uc24
        try {
            setOralTestResult( lpf.getBsl() );
        } catch (Exception e) {
            
            throw new IllegalArgumentException("No bsl\n");
        }
    }
    ...
    /**
     * Getter of OralTest result 
     * @return oral test result
     */
    public float getOralTestResult () {
        return bsl;
    }

   /**
    * setter of oralTestResult
    * @param bsl new oralTest result
    */
    public void setOralTestResult ( float bsl ) {
        this.bsl = bsl;
    }
